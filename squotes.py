...
@Client.on_message(filters.command(["q", "quote"], prefixes='!') & filters.me)
...
@Client.on_message(filters.command(["fq", "fakequote"], prefixes='!') & filters.me)
...
@Client.on_message(filters.command('squotes_help', prefixes='!') & filters.me)
...
module_list['Squotes'] = "Много команд. Для просмотра: !squotes_help."
