...
@Client.on_message(filters.command("covid", prefixes='!') & filters.me)
...
@Client.on_message(filters.command("regions", prefixes='!') & filters.me)
...
module_list['StatisticsCovid19'] = '!covid [регион]'
